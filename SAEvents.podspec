...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/SuperAwesomeLTD/sa-mobile-lib-ios-events.git", :tag => "1.5.9" }
  s.platform     = :ios, '7.0'
  s.requires_arc = true
  s.default_subspec = 'Core'
  s.dependency 'SAUtils', '1.4.3'
  s.dependency 'SANetworking', '0.2.4'
  s.dependency 'SAModelSpace', '0.2.9'
  s.subspec 'Core' do |c|
