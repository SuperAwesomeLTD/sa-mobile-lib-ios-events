//
//  SAEvents_SAViewableImpressionEvent_Tests.m
//  SAEvents
//
...
@interface SAEvents_SAViewableImpressionEvent_Tests : XCTestCase

@end

@implementation SAEvents_SAViewableImpressionEvent_Tests
...
- (void) test1 {
    ...
    XCTAssertTrue([[query objectForKey:@"data"] rangeOfString:@"type%22%3A%22viewable_impression"].location != NSNotFound);
