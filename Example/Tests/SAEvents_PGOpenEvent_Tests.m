...
@interface SAEvents_PGOpenEvent_Tests : XCTestCase

@end

@implementation SAEvents_PGOpenEvent_Tests
...
- (void) test1 {
    ...
    SAPGOpenEvent *event = [[SAPGOpenEvent alloc] initWithAd:ad andSession:session];
    ...
    XCTAssertTrue([[query objectForKey:@"data"] rangeOfString:@"type%22%3A%22parentalGateOpen"].location != NSNotFound);
