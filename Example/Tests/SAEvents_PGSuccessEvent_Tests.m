//
//  SAEvents_PGSuccessEvent_Tests.m
//  SAEvents
//
...
@interface SAEvents_PGSuccessEvent_Tests : XCTestCase

@end

@implementation SAEvents_PGSuccessEvent_Tests
...
- (void) test1 {
    ...
    SAPGSuccessEvent *event = [[SAPGSuccessEvent alloc] initWithAd:ad andSession:session];
    ...
    XCTAssertTrue([[query objectForKey:@"data"] rangeOfString:@"type%22%3A%22parentalGateSuccess"].location != NSNotFound);
