...
@interface SAEvents_PGCloseEvent_Tests : XCTestCase

@end

@implementation SAEvents_PGCloseEvent_Tests
...
- (void) test1 {
    ...
    SAPGCloseEvent *event = [[SAPGCloseEvent alloc] initWithAd:ad andSession:session];
    ...
    XCTAssertTrue([[query objectForKey:@"data"] rangeOfString:@"type%22%3A%22parentalGateClose"].location != NSNotFound);
