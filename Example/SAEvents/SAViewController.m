...
- (void) viewDidLoad {
    ...
    _moat = [[SAMoatModule alloc] initWithAd:ad andLoggingEnabled:false];
    ...
    [[[SAFileDownloader alloc] init] downloadFileFrom:@"https://sa-beta-ads-video-transcoded-superawesome.netdna-ssl.com/uKCcG2tSUM5mquPclh79M1XMW2XJvPwW.mp4" andResponse:^(BOOL success, NSString *url, NSString *diskPath) {
